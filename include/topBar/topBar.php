        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php
                    ...
                    //$unread_messages_count = $unread_messages_count ? "" : $unread_messages_count;
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                    ...
                                    if ($unread_messages_count > 0) {
                                        ...
                                        $number = number_format($unread_messages_count);
                                        echo "
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item text-center small text-gray-500" href="messageCenter.php?title=INBOX">Read More Messages</a>
                                </div>
                            </li>
                        ';
