...
$periodFrom = "2021-07-01";
$periodTo = "2021-08-31";
$approved = "Approved";
$i = 6; // assign starting value to array index
$sn = 1;
$c = 0;
// get the values from multiple tables
for ($b = 1; $b <= count($tables); $b++) {

    $table_name = $tables[$c];

    // Get "credit" and "debit" from TABLE ckc_2021_balance_sheet_assets_AS1000000
    $sql = "SELECT debit_balance, credit_balance, voucher_date FROM $table_name WHERE post_status = '$approved' AND voucher_date >= '$periodFrom' ORDER BY voucher_date ASC";
    ...
    ///*
    echo "<br/> TABLE: $sn) ".$table_name;
    echo ". Debit: ".$C_debit[$i];
    echo ". Credit: ".$D_credit[$i]."<br/>";
    //*/
    $sn++;
    $c++;
