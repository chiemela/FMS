<div class="row">
    <div class="col-lg-5">
        ...
        <h6 class="d-flex align-items-center mb-3" style="color:black;">M|Card Transaction History</h6>
    </div>
    <div class="col-lg-7">
...
<div class="table-responsive">
    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
        <?php
            ...
            $sql = "SELECT amount, voucher_date, staff_name, approved_by FROM ckc_2021_mcard_credit WHERE post_status = '$approved' AND acc_number = '$acc_number'";
    ...
    <?php
        ...
        $transaction_balance = $transaction_credit_amount;
